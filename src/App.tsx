  ...
  return (
    <div className="min-h-screen bg-[#FCFCF9] dark:bg-[#09090b] text-[#1C1917] dark:text-[#F5F5F0] antialiased selection:bg-[#DAA520]/20">
      ...
      <div className="sticky top-0 z-50 backdrop-blur-xl bg-[#FCFCF9]/80 dark:bg-[#09090b]/80 border-b border-[#E7E5E4] dark:border-[#27272a] dark:border-[#27272a]">
        <div className="max-w-[1200px] mx-auto px-2 sm:px-6 h-[64px] flex items-center justify-between">
          ...
          <div className="flex-1 md:flex-none overflow-x-auto no-scrollbar flex items-center mx-2 md:mx-4 px-1 py-2">
...
function Flow1({ setActive }: { setActive:(n:number)=>void }) {
  const roles = [
    { icon:<Layers size={24} className="text-[#D97706]" />, bg:"#FEF3C7", title:"College Admin", desc:"For principals & registrars", meta:"Manage 328 colleges • NAAC ready", action:1 },
    { icon:<Users size={24} className="text-[#DB2777]" />, bg:"#FCE7F3", title:"HOD", desc:"Department oversight & faculty review", meta:"4,215 feedbacks • 28 faculty avg", action:2 },
    { icon:<GraduationCap size={24} className="text-[#2563EB]" />, bg:"#DBEAFE", title:"Faculty", desc:"View your teaching impact anonymously", meta:"98.4% attendance • 45k logs", action:2 },
    { icon:<FileText size={24} className="text-[#059669]" />, bg:"#DCFCE7", title:"Student", desc:"Attendance, feedback & notes in one place", meta:"Batch 2024-2028 • CSE • Sec A", action:3 },
  ];
  return (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[40%_60%]  border-x border-b border-[#E7E5E4] dark:border-[#27272a] bg-white dark:bg-[#18181b] rounded-b-[16px] overflow-hidden mx-4 sm:mx-6">
      <div className="bg-[#FEF3C7] dark:bg-[#78350F]/20 p-8 sm:p-10 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="mt-6 space-y-4">
            {[
              { t:"Manage departments", d:"Create HODs, faculty, sections in 2 clicks", i:"Γùº" },
              { t:"Track faculty performance", d:"Anonymous feedback, not ratings warfare", i:"Γùê" },
              { t:"Review student feedback", d:"Filter by subject, sentiment, semester", i:"ΓùÄ" },
              { t:"Export NAAC reports", d:"One-click compliance PDFs — 2024 format", i:"Γºë" },
            ].map(b=>(
        ...
        <div className="relative mt-10 h-[240px]">
          ...
          <div className="absolute left-6 top-6 rotate-[-3deg] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] rounded-[12px] px-3 py-2 shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
            ...
            <div className="text-[11px] text-[#059669] mt-1">Γåæ 12% this sem</div>
          </div>
      ...
      <div className="p-8 sm:p-12 flex justify-center">
        <div className="w-full max-w-[380px]">
          <button onClick={()=>setActive(0)} className="mono text-[12px] text-[#78716C] hover:text-[#1C1917] inline-flex items-center gap-1.5">ΓåÉ Back to roles</button>
          <h2 className="serif text-[28px] tracking-tight mt-6">College Admin access</h2>
          <p className="text-[13px] text-[#78716C] mt-2">Use your official college email. WeΓÇÖll never share it.</p>
          ...
          <div className="mt-8 space-y-5">
            ...
            <button className="w-full h-[44px] rounded-[12px] border border-[#E7E5E4] dark:border-[#27272a] bg-white dark:bg-[#18181b] text-[13px] font-medium inline-flex items-center justify-center gap-2 hover:bg-[#F5F5F0]">
              Register your institution <span className="text-[#F59E0B]">Γåù</span>
            </button>
          ...
          <>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <div className="bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] rounded-[12px] p-3">
                ...
                <div className="text-[11px] text-[#059669]">Γåæ 8.2%</div>
              </div>
              <div className="bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] rounded-[12px] p-3">
            ...
            <div className="mt-6 rounded-[12px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] p-3 flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-[#F5F5F0] flex items-center justify-center">Γùº</div>
        ...
        <div className="w-full max-w-[380px]">
          ...
          <div className="mt-7 space-y-5" ref={instRef}>
            ...
            <div>
              ...
              <div className="mt-1.5 mono text-[11px] text-[#78716C]">WeΓÇÖll send a magic link if password fails.</div>
            </div>
  ...
  return (
    <div className="p-6 lg:p-10 bg-[#FCFCF9] min-h-full">
      ...
      <div className="bg-white dark:bg-[#18181b] rounded-3xl border border-[#E7E5E4] dark:border-[#27272a] shadow-sm max-w-4xl mx-auto w-full p-12 flex flex-col items-center min-h-[400px]">
        ...
        {step === 2 && (
          <div className="w-full flex flex-col items-center animate-[fadeIn_0.3s_ease]">
            <div className="text-sm font-bold text-[#78716C] tracking-widest uppercase mb-6">Select Subject / Course</div>
        ...
        {step === 3 && (
          <div className="w-full flex flex-col animate-[fadeIn_0.3s_ease]">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 border-b border-[#E7E5E4] dark:border-[#27272a] pb-4 w-full">
               <div>
  ...
  return (
    <div className="w-full max-w-[1000px] mx-auto flex flex-col md:flex-row gap-6 p-6 animate-[fadeIn_0.4s_ease] min-h-[calc(100vh-100px)] items-center">
      ...
      <div className="w-full md:w-1/2 bg-[#F0FDF4] rounded-[24px] p-8 md:p-12 flex flex-col relative overflow-hidden h-auto lg:h-[720px]">
        ...
        <p className="text-[14px] text-[#065F46] leading-relaxed mb-6">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <button onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[12px] font-bold text-[#78716C] hover:text-[#1C1917]">Show</button>
            </div>
          </div>
      ...
      <div className="h-[56px] bg-white dark:bg-[#18181b] border-b border-[#E7E5E4] dark:border-[#27272a] flex items-center justify-between px-4 sm:px-6 shrink-0">
        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden sm:flex items-center gap-2 h-9 w-[280px] px-3 rounded-[10px] bg-[#F5F5F0] border border-[#E7E5E4] dark:border-[#27272a] text-[13px] text-[#A8A29E] focus-within:border-[#1C1917] focus-within:bg-white dark:bg-[#18181b] transition-colors z-50">
            <span className="text-[14px]">Γîò</span> 
            <input 
              value={dashSearch}
            ...
            />
            <span className="ml-auto mono text-[10px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] rounded px-1.5 py-0.5 shadow-sm text-[#78716C]">ΓîÿK</span>
...
{/* Merged Welcome & University Reg Card */}
              ...
              <div className="lg:col-span-2 bg-white dark:bg-[#18181b] rounded-[20px] border border-[#E7E5E4] dark:border-[#27272a] p-6 shadow-sm">
                <div className="flex justify-between items-start mb-2">
                  <div className="flex items-center gap-3">
                    <span className="w-7 h-7 rounded-full bg-[#E0F2FE] flex items-center justify-center text-[#0369A1] text-[12px]">ΓùÄ</span>
...
{studentTab === 'CIE Marks' && <CIEMarksFlow />}
            ...
            <div className="space-y-6 pb-12">
              <div className="bg-white dark:bg-[#18181b] rounded-[16px] border border-[#E7E5E4] dark:border-[#27272a] p-6">
                ...
                <div className="mt-6 rounded-[12px] bg-[#DCFCE7] border border-[#A7F3D0] p-4 flex items-center gap-3 text-[13px] text-[#065F46]">
                  <div className="w-8 h-8 rounded-full bg-white dark:bg-[#18181b] border border-[#A7F3D0] flex items-center justify-center text-[#059669]">Γä╣</div>
        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="h-9 w-[320px] lg:w-[480px] rounded-full border border-[#E7E5E4] dark:border-[#27272a] bg-[#F5F5F0] flex items-center px-3 gap-2 text-[13px] text-[#78716C] focus-within:border-[#1C1917] focus-within:bg-white dark:bg-[#18181b] transition-colors">
            ...
            <input 
              ...
              className="flex-1 bg-transparent outline-none truncate text-[#1C1917]" 
            />
            <span className="ml-auto mono text-[10px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] rounded px-1">ΓîÿK</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr]">
        <div className="bg-[#F5F5F0] p-4 border-b lg:border-b-0 lg:border-r border-[#E7E5E4] dark:border-[#27272a]">
          ...
          <div className="mt-6 space-y-1">
            ...
            <div className="pt-4">
              ...
              <div className="rounded-[12px] bg-[#FEF3C7] border border-[#FDE68A] p-2">
                <div className="flex items-center gap-2 text-[13px] font-medium"><span>≡ƒôü</span> CSE</div>
          ...
          <div className="mt-6 rounded-[12px] bg-[#FFFBEB] border border-[#FDE68A] p-3">
            ...
            <div className="mt-2 text-[11px]">Γåù Try CSE → Sem 5</div>
          </div>
        </div>
          ...
          {noteView==='search' ? (
            <>
              ...
              <div className="mt-6 h-[48px] rounded-[12px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] flex items-center px-3.5 gap-2 focus-within:border-[#1C1917]">
                <span className="text-[#A8A29E]">Γîò</span>
                <input 
                  value={searchQuery}
              ...
              <div className="mt-5 flex flex-wrap items-center gap-2">
                ...
                <div className="ml-2 h-8 px-3 rounded-full bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] text-[12px] flex items-center gap-1">Resource Type Γû╛</div>
              </div>
            ...
            <>
              ...
              <div className="mt-6 flex items-center gap-2">
                ...
                <button onClick={()=>setNoteView('search')} className="ml-auto mono text-[11px] underline underline-offset-4">ΓåÉ Back to search</button>
              </div>

              <div className="mt-4 flex gap-1.5 flex-wrap">
                {"ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("").map(l=>(
                  <div key={l} className={`w-7 h-7 rounded-[8px] border flex items-center justify-center text-[11px] font-medium ${l==="A" ? "bg-[#FEF3C7] border-[#FDE68A] text-[#92400E]" : "bg-white dark:bg-[#18181b] border-[#E7E5E4] dark:border-[#27272a] text-[#78716C]"}`}>{l}{l==="A" ? "Γÿà" : ""}</div>
                ))}
              </div>
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  <div key={s.code} className="rounded-[16px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] p-4 hover:border-[#1C1917] transition-colors group">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2"><span className="w-6 h-6 rounded-[8px] bg-[#F5F5F0] border border-[#E7E5E4] dark:border-[#27272a] flex items-center justify-center text-[12px]">≡ƒôü</span><span className="mono text-[11px] text-[#78716C]">{s.code}</span></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="lg:col-span-2 bg-white/90 backdrop-blur-sm border border-[#E7E5E4] dark:border-[#27272a] rounded-[20px] sm:rounded-[24px] p-6 sm:p-8 shadow-sm flex flex-col sm:flex-row gap-6 sm:gap-8 hover:-translate-y-0.5 transition-transform duration-300">
                <div className="w-full sm:w-32 h-32 rounded-[16px] bg-[#FAFAFA] border border-[#F5F5F0] flex flex-col items-center justify-center shrink-0">
                  <div className="text-[40px] opacity-20">≡ƒºè</div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5 sm:gap-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 text-[#A8A29E] pointer-events-none">Γîä</div>
                  </div>
                </div>
                <div>
          ...
          <div className="flex flex-col gap-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              ...
              <div className="flex items-center gap-2 text-[11px] text-[#A8A29E] mono">
                <span>≡ƒòÆ</span> Last updated 2 min ago • Live from EPCET
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/90 backdrop-blur-sm border border-[#E7E5E4] dark:border-[#27272a] rounded-[20px] sm:rounded-[24px] p-5 sm:p-8 shadow-sm flex flex-col justify-between min-h-[220px] hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex text-[#F59E0B] text-[18px]">ΓÿàΓÿàΓÿàΓÿà<span className="text-[#E7E5E4]">Γÿà</span></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-[#E7E5E4] dark:border-[#27272a] rounded-[16px] p-5 shadow-sm">
                ...
                <div className="text-[11px] text-[#78716C] mono">Γÿà across depts</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-[#E7E5E4] dark:border-[#27272a] rounded-[16px] p-5 shadow-sm">
                <div className="flex items-center gap-2 text-[10px] font-bold text-[#A8A29E] tracking-widest uppercase mb-3">
                  <span>≡ƒ¢í∩╕Å</span> VERIFIED TODAY
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1">
                          <span className="text-[#059669] text-[12px]">ΓÿàΓÿàΓÿàΓÿàΓÿà</span>
                  ...
                  <div className="border border-[#FDE68A] bg-[#FEF3C7]/20 rounded-[16px] p-5 flex flex-col gap-3">
                    <div className="flex items-center gap-1.5 text-[10px] font-bold text-[#D97706] tracking-widest uppercase">
                      <span>ΓÜá∩╕Å</span> NEEDS ATTENTION
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1">
                          <span className="text-[#D97706] text-[12px]">ΓÿàΓÿàΓÿàΓÿåΓÿå</span>
          ...
          <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/90 backdrop-blur-sm border border-[#E7E5E4] dark:border-[#27272a] rounded-[24px] p-10 flex flex-col items-center justify-center text-center shadow-sm h-[400px]">
                ...
                <button className="px-6 py-2.5 bg-[#1C1917] text-white text-[13px] font-medium rounded-full shadow-sm hover:scale-95 transition-transform flex items-center gap-2">
                  <span>Γ£ë</span> Send reminder to students
                </button>
            ...
            <div className="mt-4 flex flex-col gap-4">
              ...
              <div className="flex justify-between items-center text-[10px] text-[#A8A29E] mono mt-4 pb-8">
                ...
                <div><span className="text-[#F59E0B]">Γÿà</span> EduFeedback Pro - human best</div>
              </div>
            </div>
          </div>
        )}
                ...
                <tbody>
                  <tr className="group hover:bg-[#FAFAFA] transition-colors">
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                      <div className="flex items-center gap-2 mono text-[13px] text-[#1C1917] font-medium">#1 <span className="text-[16px]">≡ƒÑç</span></div>
                    </td>
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                    ...
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                      <div className="flex items-center gap-2 bg-[#DCFCE7]/30 px-3 py-1.5 rounded-full w-fit">
                        <span className="text-[#059669] text-[13px]">ΓÿàΓÿàΓÿàΓÿàΓÿà</span>
                  ...
                  <tr className="group hover:bg-[#FAFAFA] transition-colors">
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                      <div className="flex items-center gap-2 mono text-[13px] text-[#1C1917] font-medium">#2 <span className="text-[16px]">≡ƒÑê</span></div>
                    </td>
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                    ...
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                      <div className="flex items-center gap-2 bg-[#DCFCE7]/30 px-3 py-1.5 rounded-full w-fit">
                        <span className="text-[#059669] text-[13px]">ΓÿàΓÿàΓÿàΓÿà<span className="text-[#A8A29E]/50">Γÿà</span></span>
                  ...
                  <tr className="group hover:bg-[#FAFAFA] transition-colors">
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                      <div className="flex items-center gap-2 mono text-[13px] text-[#1C1917] font-medium">#3 <span className="text-[16px]">≡ƒÑë</span></div>
                    </td>
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                    ...
                    <td className="py-5 px-6 border-b border-[#F5F5F0]">
                      <div className="flex items-center gap-2 bg-[#FEF3C7]/40 px-3 py-1.5 rounded-full w-fit">
                        <span className="text-[#D97706] text-[13px]">ΓÿàΓÿàΓÿà<span className="text-[#A8A29E]/50">ΓÿàΓÿà</span></span>
