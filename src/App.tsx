...
const tabs = ["Select Role", "College Login", "HOD & Faculty", "Student Login", "NoteHub"] as const;
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFCF9] dark:bg-[#09090b] text-[#1C1917] dark:text-[#F5F5F0] antialiased selection:bg-[#DAA520]/20">
      ...
      {active < 5 && (
        <div className="sticky top-0 z-50 backdrop-blur-xl bg-[#FCFCF9]/80 dark:bg-[#09090b]/80 border-b border-[#E7E5E4] dark:border-[#27272a]">
      ...
      <div className="bg-[#FEF3C7] dark:bg-[#78350F]/20 p-8 sm:p-10 relative overflow-hidden">
        ...
        <div className="relative mt-10 h-[240px]">
          <svg viewBox="0 0 320 180" className="w-full h-full">
            ...
            <rect x="38" y="75" width="14" height="18" rx="3" fill="white" stroke="#E7E5E4" />
          </svg>
      ...
      <div className="flex flex-col bg-white dark:bg-[#09090b] h-full relative overflow-y-auto">
        <div style={{ zoom: 0.95 }} className="flex flex-col px-8 lg:px-20 py-16 w-full max-w-[640px] mx-auto h-full">
          <div className="flex justify-end mb-8">
            <button type="button" onClick={() => setActive(0)} className="inline-flex items-center gap-2 bg-[#F5F5F0] dark:bg-[#18181b] text-[#1C1917] dark:text-[#F5F5F0] font-medium text-[13px] px-3 py-1.5 rounded-full hover:bg-[#E7E5E4] transition-colors border border-[#E7E5E4] dark:border-[#27272a]">
              &lt; Back to Roles
            </button>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <form onSubmit={(e) => { e.preventDefault(); setActive(5); }} className="space-y-5" noValidate>
              <div>
                ...
                <div className="flex items-center gap-3 rounded-[12px] border border-[#E7E5E4] dark:border-[#27272a] bg-[#F5F5F0] dark:bg-[#18181b] px-4 py-3.5 focus-within:border-[#1C1917] focus-within:ring-1 focus-within:ring-[#1C1917] transition-all">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 rounded-[12px] border border-[#E7E5E4] dark:border-[#27272a] bg-[#F5F5F0] dark:bg-[#18181b] px-4 py-3.5 focus-within:border-[#1C1917] focus-within:ring-1 focus-within:ring-[#1C1917] transition-all relative">
    ...
    <div className="border-x border-b border-[#E7E5E4] dark:border-[#27272a] rounded-b-[16px] overflow-hidden mx-4 sm:mx-6 bg-white dark:bg-[#18181b]">
      <div className="h-[56px] border-b border-[#E7E5E4] dark:border-[#27272a] flex items-center justify-between px-4 sm:px-6 gap-3">
        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="h-9 w-[320px] lg:w-[480px] rounded-full border border-[#E7E5E4] dark:border-[#27272a] bg-[#F5F5F0] dark:bg-[#18181b] flex items-center px-3 gap-2 text-[13px] text-[#78716C] dark:text-[#A8A29E] focus-within:border-[#1C1917] focus-within:bg-white dark:bg-[#18181b] transition-colors">
            ⌕
            <input
              value={searchQuery}
              onChange={e => {
              ...
              className="flex-1 bg-transparent outline-none truncate text-[#1C1917] dark:text-[#F5F5F0]"
            />
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="hidden sm:inline-flex h-8 px-3 rounded-full text-[12px] items-center text-[#78716C] dark:text-[#A8A29E]">High School</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr]">
        <div className="bg-[#F5F5F0] dark:bg-[#18181b] p-4 border-b lg:border-b-0 lg:border-r border-[#E7E5E4] dark:border-[#27272a]">
          ...
          <div className="mono text-[11px] text-[#78716C] dark:text-[#A8A29E] mt-2 px-1">Share notes, PPTs, lab manuals →</div>

          <div className="mt-6 space-y-1">
            {[{ l: "Home", a: true }, { l: "Library" }, { l: "Recent" }].map(i => (
              <div key={i.l} className={`h-8 px-2.5 rounded-[10px] flex items-center gap-2 text-[13px] ${i.a ? "bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] font-medium" : "text-[#57534E] dark:text-[#A8A29E]"}`}>
            ...
            <div className="pt-4">
              ...
              <div className="rounded-[12px] bg-[#FEF3C7] border border-[#FDE68A] p-2">
                ...
                <div className="mt-2 space-y-1 pl-6">
                  <div className="text-[12px] text-[#57534E] dark:text-[#A8A29E]">Sem 1 • 2 files</div>
                  <div className="text-[12px] text-[#57534E] dark:text-[#A8A29E]">Sem 2 • 12 files</div>
              ...
              <div className="mt-2 px-2 py-1.5 text-[13px] text-[#78716C] dark:text-[#A8A29E]">ECE • 32 files</div>
              <div className="px-2 py-1.5 text-[13px] text-[#78716C] dark:text-[#A8A29E]">ME • 18 files</div>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-[12px] bg-[#FFFBEB] border border-[#FDE68A] p-3">
            ...
            <div className="text-[11px] text-[#78716C] dark:text-[#A8A29E] leading-5 mt-1">Select a Dept → Sem → Subject to see notes, PPTs, lab manuals, PYQs</div>
        ...
        <div className="p-5 sm:p-8 bg-[#FCFCF9]">
          {noteView === 'search' ? (
            <>
              ...
              <p className="text-[14px] text-[#78716C] dark:text-[#A8A29E] mt-2">Search across EPCET Engineering. Everything is peer-verified.</p>
              ...
              <div className="mt-6 h-[48px] rounded-[12px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] flex items-center px-3.5 gap-2 focus-within:border-[#1C1917]">
                ...
                <input
                  ...
                  autoFocus
                />
                <span className="mono text-[10px] bg-[#F5F5F0] dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] rounded-full px-2 py-1">Press / to focus</span>
              </div>

              <div className="mt-5 flex flex-wrap items-center gap-2">
                {["All Sections", "Academic", "Lab Resources"].map(f => (
                  <button key={f} className={`h-8 px-3.5 rounded-full text-[12px] border ${f === "All Sections" ? "bg-[#1C1917] text-white border-[#1C1917]" : "bg-white dark:bg-[#18181b] border-[#E7E5E4] dark:border-[#27272a] text-[#57534E] dark:text-[#A8A29E]"}`}>{f}</button>
                ))}
              ...
              <div className="mt-6 mono text-[12px] text-[#A8A29E] flex items-center justify-between">
                ...
                <button onClick={() => { setNoteView('cse5'); setSearchQuery(''); }} className="underline underline-offset-4 text-[#1C1917] dark:text-[#F5F5F0]">Go to CSE5 →</button>
              </div>
              ...
              <div className="mt-4 space-y-2">
                ...
                {filteredDocs.length > 0 ? filteredDocs.map((doc, idx) => (
                  <div key={idx} className="rounded-[12px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] p-4 flex items-center justify-between hover:bg-[#F5F5F0] dark:bg-[#18181b] transition-colors cursor-pointer">
                    <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="hidden sm:flex w-9 h-9 rounded-[10px] bg-[#F5F5F0] dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] items-center justify-center">📄</div>
                      <span className="px-2.5 py-1 rounded-full bg-[#1C1917] text-white mono text-[10px]">{doc.format}</span>
                    </div>
                  </div>
                )) : (
                  <div className="p-8 text-center text-[#78716C] dark:text-[#A8A29E] text-[14px]">No materials found for "{searchQuery}"</div>
                )}
              </div>
            </>
          ) : (
            <>
              ...
              <div className="mt-5 flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-[14px] text-[#78716C] dark:text-[#A8A29E] mt-2">5th Semester core subjects • Updated for 2026 syllabus • Lab manuals included.</p>
                </div>
              ...
              <div className="mt-4 flex gap-1.5 flex-wrap">
                {"ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("").map(l => (
                  <div key={l} className={`w-7 h-7 rounded-[8px] border flex items-center justify-center text-[11px] font-medium ${l === "A" ? "bg-[#FEF3C7] border-[#FDE68A] text-[#92400E]" : "bg-white dark:bg-[#18181b] border-[#E7E5E4] dark:border-[#27272a] text-[#78716C] dark:text-[#A8A29E]"}`}>{l}{l === "A" ? "★" : ""}</div>
                ))}
              </div>
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  <div key={s.code} className="rounded-[16px] bg-white dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] p-4 hover:border-[#1C1917] transition-colors group">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2"><span className="w-6 h-6 rounded-[8px] bg-[#F5F5F0] dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] flex items-center justify-center text-[12px]">📁</span><span className="mono text-[11px] text-[#78716C] dark:text-[#A8A29E]">{s.code}</span></div>
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      <span className="px-2 py-1 rounded-full bg-[#F5F5F0] dark:bg-[#18181b] border border-[#E7E5E4] dark:border-[#27272a] mono text-[10px]">notes • PPTs • PYQs</span>
                    </div>
