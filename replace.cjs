          ...
          {adminTab === 'Dashboard' ? (
            <div className="max-w-[1000px] mx-auto space-y-6 pb-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
                <div className="lg:col-span-2 bg-white border border-[#E7E5E4] rounded-[16px] p-6 shadow-sm">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="px-3 py-1 bg-[#DCFCE7] text-[#059669] text-[10px] font-bold rounded-full tracking-widest">COMPUTED LIVE</div>
                  </div>
              ...
              <div className="bg-white border border-[#E7E5E4] rounded-[16px] shadow-sm mt-8 overflow-hidden">
                <div className="px-6 py-5 border-b border-[#E7E5E4] flex justify-between items-center">
                  ...
                  <div className="px-3 py-1 bg-[#FAFAFA] border border-[#E7E5E4] rounded-full text-[11px] font-medium text-[#78716C]">6 Departments</div>
                </div>
                ...
                <div className="px-6 py-4 bg-[#FCFCF9] border-t border-[#E7E5E4] flex justify-between items-center">
                  <div className="text-[12px] text-[#78716C]">Empty slots show 0.00 amber — collect first feedback to populate.</div>
                  <button className="px-4 py-2 bg-[#1C1917] text-white text-[12px] font-medium rounded-full shadow-sm">Export CSV</button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                <div className="bg-white border border-[#E7E5E4] rounded-[16px] p-6 shadow-sm flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-8 mb-8">
                    <div className="w-24 h-24 rounded-full border-[8px] border-[#F5F5F0] flex items-center justify-center flex-col shrink-0">
                    ...
                    <div>
                      ...
                      <button className="px-4 py-2 bg-[#F5F5F0] text-[#1C1917] text-[13px] font-medium rounded-full hover:bg-[#E7E5E4]">Invite Students</button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 pt-6 border-t border-[#E7E5E4]">
                    <div className="flex justify-between items-center text-[13px]">
                      ...
                      <span className="font-medium text-[#1C1917]">0 / 0 <span className="text-[#A8A29E]">Students</span></span>
                    </div>
                    <div className="flex justify-between items-center text-[13px]">
                      <span className="text-[#78716C]">Total Responses</span>
                      <span className="font-medium text-[#1C1917]">0 <span className="text-[#A8A29E]">feedbacks</span></span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-[#E7E5E4] rounded-[16px] p-6 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-6">
                    ...
                    <button className="px-4 py-2.5 bg-[#1C1917] text-white text-[13px] font-medium rounded-full hover:bg-black">Reset View</button>
                  </div>
                </div>
              </div>
              
              {/* Security Lock Bottom */}
              <div className="mt-8 bg-[#1C1917] rounded-[16px] p-6 flex items-center justify-between shadow-md">
                <div className="flex items-center gap-5">
                  <div className="w-12 h-12 rounded-full bg-[#D97706]/10 border border-[#D97706]/30 flex items-center justify-center text-[#FDE68A] text-xl">🔒</div>
                  <div>
                    <h3 className="text-[14px] font-bold text-white tracking-widest uppercase mb-1">ENTERPRISE SECURITY LOCK — FEEDBACK ENCRYPTED AT REST</h3>
                    <p className="text-[13px] text-[#A8A29E]">Anonymous collection, role-based access, audit trail enabled for compliance.</p>
                  </div>
                </div>
                <div className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-[12px] text-[#A8A29E] font-mono">
                  Selected Batch: —
                </div>
              </div>
